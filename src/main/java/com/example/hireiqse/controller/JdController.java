// controller/JdController.java
// Member 06 - Handles JD analysis endpoints.
//
// Endpoints:
//   POST /api/jd/analyze       - analyze and refine a job description
//   GET  /api/jd/history       - get past analyses for a job (?jobId=1)
